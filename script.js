...
if (document.getElementById('qrcode')) generateQR(false);
if (document.getElementById('passOutput')) generatePassword();
if (document.getElementById('wordInput')) analyzeText();